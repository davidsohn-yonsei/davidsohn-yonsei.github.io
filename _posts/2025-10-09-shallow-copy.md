...
위에서는 뭔가 거창하게 이야기했고 또 실제 내용이 이미 pdf에 있지만, 다시 쓰고자 한다.<br>
...
이 얕은 복사를 위해 저렇게 하는 게 말이 안 된다고 생각했다.<br><br>
...
또 시퀀스가 아니어도 문제를 일으키지 않을 저 x * 1 이 낫지 않겠냐고.<br><br>
...
다른 보고서 속 내용들도 겸사겸사 여기에 더 쓰고자 한다.<br>
...
그래도 여전히 집합은 아니지만 이 리스트에 대한 복사를 집합론으로 접근하는 방식은 가치가 있었다고 생각했었고, 지금도 그 생각은 변하지 않는다.
<br><br>
...
그러다가 공집합을 더하는 방식, 즉 x + []을 떠올렸다.<br>
...
이런 사례를 딱 학기가 지나자마자 그것도 숙제로 마주친 게게 나름 재밌는 우연이라고 생각한다.
