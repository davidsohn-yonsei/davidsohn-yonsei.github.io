...
그러다가 리스트 * 1이라는 방법을 가장 먼저 떠올리게 됐다.
* 2를 한 결과가 분명 다른 오브젝트였으니까, * 1도 그렇지 않겠냐는 것.
그리고 그렇다면, 세 번이나 인수를 확인하는 슬라이싱보다도 빠르고,
또 시퀀스가 아니어도 문제를 일으키지 않을 저 * 1 이 낫지 않겠냐고.

그렇게 후일 이 발견을 기록화하고자 보고서를 학기 말에 쓰고 이메일로 보내겠다고 교수님께 말씀드렸었다.
문제는, 슬라이싱과의 속도 비교에 대해 고민하는 것도 문제였지만,
다른 두 방법까지 찾게 되어버린 것이었다.
